<template>
  <div>
    <div
      ...
      v-bind:id="dd"
      tabindex="-1"
      aria-labelledby="ccModalLabel"
      aria-hidden="true"
    >
      <div class="modal-dialog modal-xl">
        <div class="modal-content text-dark">
          <div class="modal-header">
            <h1 class="modal-title fs-5" id="ccModalLabel">
          ...
          <form action="" @submit="saveData">
            <div class="modal-body">
              ...
              <div class="row">
                <div class="col-sm-3">
                  <label for="date">Mouvement</label>
                  <input
                    class="form-control"
                    type="text"
                    v-model="date"
              ...
              <div class="row">
                <div class="col-sm-3">
                  <label for="oedeme">Oedemes</label>
                  <input
                    class="form-control"
                    type="text"
                    v-model="oedeme"
                    id="oedeme"
                  />
                  <span style="color: red">{{ error_oedemes }}</span>
                </div>
                <div class="col-sm-3">
                  <label for="p">P</label>
                  <input class="form-control" type="text" v-model="p" id="p" />
                  <span style="color: red">{{ error_p }}</span>
                </div>
                <div class="col-sm-3">
                  ...
                  <input
                    ...
                    id="obst"
                  />
                  <span style="color: red">{{ error_obst }}</span>
                </div>
                <div class="col-sm-3">
                  ...
                  <input
                    ...
                    id="bassin"
                  />
                  <span style="color: red">{{ error_bassin }}</span>
                </div>
              </div>
              <div class="row">
                <div class="col-sm-3">
                  ...
                  <input
                    ...
                    id="ddr"
                  />
                  <span style="color: red">{{ error_ddr }}</span>
                </div>
                <div class="col-sm-3">
                  ...
                  <input
                    ...
                    id="dpa"
                  />
                  <span style="color: red">{{ error_dpa }}</span>
                </div>
                <div class="col-sm-3">
                  <label for="albu">Albumine</label>
                  <input
                    class="form-control"
                    type="text"
                    v-model="albu"
                    id="albu"
                  />
                  <span style="color: red">{{ error_albu }}</span>
                </div>
                <div class="col-sm-3">
                  ...
                  <input
                    ...
                    id="sucre"
                  />
                  <span style="color: red">{{ error_sucre }}</span>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-sm-3">
                  ...
                  <input
                    ...
                    id="ta"
                  />
                  <span style="color: red">{{ error_ta }}</span>
                </div>
                <div class="col-sm-3">
                  ...
                  <input
                    ...
                    id="gs"
                  />
                  <span style="color: red">{{ error_gs }}</span>
                </div>
                <div class="col-sm-3">
                  <label for="rhe">Rhesus</label>
                  <input
                    class="form-control"
                    type="text"
                    v-model="rhe"
                    id="rhe"
                  />
                  <span style="color: red">{{ error_rhe }}</span>
                </div>
                <div class="col-sm-3">
                  <label for="rendez"> Date rendez-vous </label>
                  <input
                    class="form-control"
                    type="date"
                    v-model="rendez"
                    id="rendez"
                  />
                  <span style="color: red">{{ error_rendez }}</span>
                </div>
                <div class="col-sm-12">
                  <input
                    class="form-control"
              ...
              <div class="row">
                <div class="col-sm-12">
                  <label for="diagnos">Diagnostique</label>
                  <textarea
                    class="form-control"
                    v-model="diagnos"
                    id="diagnos"
                  ></textarea>
                  <span style="color: red">{{ error_diagnos }}</span>
                </div>
                <div class="col-sm-12">
...
<script >
export default {
  name: "consultation Chirurgie",
  props: {
    transfert: Object,
  },
  data() {
    return {
      dd: "conscModal" + this.transfert.id_transfert,
      ages: "",
      dates: "",
