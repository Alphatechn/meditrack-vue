  ...
  <div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Resultat Labo</li>
      </ol>
    </nav>
  </div>
  <!-- End Page Title -->
      ...
      <div class="card bg-white border-0">
        <div class="col-lg-12 col-md-12">
          <div class="card-header border-0 bg-white">
            <div class="row">
              <h4 id="mss">Resultat Laboratoire</h4>
            </div>
          </div>
...
<script >
import Options from "./OptionsR.vue";
export default {
  components: { Options },
  data() {
    return {
  ...
  methods: {
    ...
    async fetchConsultation() {
      const consultation = await fetch(
        "http://127.0.0.1:8000/api/consutation/labo/user/" +
